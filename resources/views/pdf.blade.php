...
@php
  ...
  @endphp
    <div class="container">
        <table width="100%">
          <tr>
            <td width="75px"><div style="background: #ffffff url(https://i.ibb.co/jykzTPB/UMSS.png);width: 50px;height: 75px;margin-right: 10px;background-position: center;background-size: 50px;"></div> </td>
